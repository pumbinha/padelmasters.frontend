...
export class HttpClient<SecurityDataType = unknown> {
	public baseUrl: string = "http://localhost:5209";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
	api = {
		 ...
		 * @secure
		 */
		padelmastersApiDomainEndpointsMatchesDeleteMatchResult: (
			matchId: string,
		 ...
		 * @secure
		 */
		padelmastersApiDomainEndpointsMatchesSearchMatches: (
			data: SearchMatchesRequest,
			params: RequestParams = {}
		) =>
		 ...
		 * @secure
		 */
		padelmastersApiDomainEndpointsMatchesUnPlanMatch: (
			matchId: string,
			params: RequestParams = {}
		) =>
			this.request<any, void>({
		 ...
		 * @secure
		 */
		padelmastersApiDomainEndpointsGroupsGetGroupStandings: (
			groupId: string,
			params: RequestParams = {}
		) =>
		 ...
		 * @secure
		 */
		padelmastersApiDomainEndpointsChampionshipsGetChampionship: (
			championshipId: string,
			params: RequestParams = {}
		) =>
		 ...
		 * @secure
		 */
		padelmastersApiDomainEndpointsChampionshipsOpenChampionship: (
			championshipId: string,
			params: RequestParams = {}
		) =>
			this.request<any, void>({
